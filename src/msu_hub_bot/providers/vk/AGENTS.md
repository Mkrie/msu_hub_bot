...
- Telegram chunking, preview budgets, media placement and destination policies belong in [telegram/links/vk.py](../../telegram/links/vk.py), using shared serialized delivery.
